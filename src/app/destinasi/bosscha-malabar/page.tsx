...
export default function BosschaMalabarPage() {
  ...
  // ─── KTP DIGITAL (SCHEMA) DESTINASI WISATA SEJARAH ───
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "TouristAttraction",
    "name": "Bosscha & Malabar Heritage Pangalengan",
    "description": "Menelusuri jejak Sang Raja Teh Priangan K.A.R Bosscha. Wisata edukasi sejarah melintasi perkebunan teh Malabar, Rumah Bosscha (Wisma Malabar), dan makam bersejarah.",
    "image": "https://www.gopangalengan.id/makam-bosscha.jpg", 
    "address": {
      "@type": "PostalAddress",
        ...
        <section className="py-12 bg-zinc-950">
          ...
          <div className="flex gap-4 overflow-x-auto pb-8 snap-x snap-mandatory px-4 sm:px-6 lg:px-8 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
            ...
            {[
              ...
              <div className="relative h-64 w-[85vw] sm:w-[400px] shrink-0 snap-center overflow-hidden rounded-2xl border border-zinc-800 shadow-lg" key={index}>
                <Image 
                  src={imgSrc} 
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid gap-4 sm:gap-6 grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <div className="rounded-xl border border-zinc-100 bg-white p-4 shadow-sm hover:border-emerald-400 hover:shadow-md transition-all duration-300" key={i}>
