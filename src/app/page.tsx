...
const kategoriPetualangan: PaketItem[] = [
  ...
  { id: "tiket-flying-fox-situ-cileunca", nama: "Flying Fox", harga: "Rp 35.000", hargaAsli: "", hargaDiskon: "Rp 35.000", fasilitas: [], image: "/flyingfox.jpg", deskripsi: "Meluncur bebas melintasi lembah dan danau. Singkat namun mendebarkan." },
  { id: "tour-perahu-situ-cileunca", nama: "Tour Perahu", harga: "Rp 20.000", hargaAsli: "", hargaDiskon: "Rp 20.000", fasilitas: [], image: "/perahu.jpg", deskripsi: "Bersantai menikmati syahdunya pemandangan Situ Cileunca dari atas perahu." },
  { id: "paket-trekking-kebun-teh-pangalengan", nama: "Treking Alam", harga: "Rp 70.000", hargaAsli: "", hargaDiskon: "Rp 70.000", fasilitas: [], image: "/treking.jpg", deskripsi: "Menjelajahi sejuknya bukit dan hamparan kebun teh dengan panduan lokal." },
];
...
const paketCombo = [
  ...
  { id: "paket-outing-corporate-offroad-1-hari", nama: "Xtreme Offroad", tag: "Corporate", durasi: "1 Hari", harga: "Rp 549.000", fasilitas: ["Rafting & Offroad", "Paintball & Ice Breaking", "Makan Siang", "Foto Rafting"], color: "text-slate-700 bg-slate-100", image: "/corporate-1n-c.jpg" },
  { id: "paket-gathering-kantor-2-hari-1-malam-hemat", nama: "Essential Trip", tag: "Corporate", durasi: "2 Hari", harga: "Rp 239.000", fasilitas: ["Fresh Rafting", "Paintball", "Makan", "Dokumentasi Rafting"], color: "text-indigo-700 bg-indigo-100", image: "/corporate-1n-a.jpg" },
  { id: "paket-outing-perusahaan-2-hari-1-malam-bestseller", nama: "Feast & Fun", tag: "Corporate", durasi: "2 Hari", harga: "Rp 650.000", fasilitas: ["Penginapan", "Rafting, Paintball, Flying Fox", "3x Makan", "Kambing Guling"], color: "text-indigo-700 bg-indigo-100", image: "/corporate-1n-b.jpg" },
  { id: "paket-gathering-corporate-2-hari-1-malam-all-in", nama: "All-Inclusive", tag: "Corporate", durasi: "2 Hari", harga: "Rp 450.000", fasilitas: ["Penginapan", "Rafting, Paintball, Flying Fox", "3x Makan", "Tour Leader"], color: "text-indigo-700 bg-indigo-100", image: "/rafting.jpg" },
  { id: "paket-outing-kantor-2-hari-1-malam-relax", nama: "Relax & Retreat", tag: "Corporate", durasi: "2 Hari", harga: "Rp 200.000", fasilitas: ["Rafting", "Fun Games", "Makan", "Dokumentasi Rafting"], color: "text-indigo-700 bg-indigo-100", image: "/paket3.jpg" },
  { id: "paket-gathering-perusahaan-vip-premium", nama: "VIP Executive", tag: "Corporate", durasi: "2 Hari", harga: "Rp 1.099.000", fasilitas: ["Villa VIP", "3x Makan", "Rafting & Team Building", "Offroad, Paintball"], color: "text-yellow-700 bg-yellow-50 border border-yellow-200", image: "/corporate-vip.jpg" },
  { id: "paket-glamping-atv-pangalengan", nama: "Glamping & ATV", tag: "Keluarga", durasi: "2 Hari", harga: "Rp 495.000", fasilitas: ["Glamping", "Sarapan & Tea Break", "Rafting & ATV", "Flying Fox"], color: "text-emerald-700 bg-emerald-100", image: "/family-camp-a.jpg" },
  { id: "paket-glamping-offroad-pangalengan", nama: "Glamping & Offroad", tag: "Keluarga", durasi: "2 Hari", harga: "Rp 620.000", fasilitas: ["Glamping", "Sarapan & Tea Break", "Rafting & Offroad", "Flying Fox"], color: "text-emerald-700 bg-emerald-100", image: "/family-camp-b.jpg" },
  { id: "paket-camping-keluarga-pangalengan", nama: "Classic Glamping", tag: "Keluarga", durasi: "2 Hari", harga: "Rp 395.000", fasilitas: ["Glamping", "Sarapan & Tea Break", "Rafting", "Flying Fox"], color: "text-emerald-700 bg-emerald-100", image: "/flyingfox.jpg" },
];

const kategoriPenginapan: PaketItem[] = [
  { id: "penginapan-saung-cinta", nama: "Saung Cinta", harga: "", hargaAsli: "", hargaDiskon: "Rp 750.000", fasilitas: ["Max 20 Orang", "Kolam Renang", "Dekat Cileunca"], label: "Budget", image: "/saung-cinta.jpg", deskripsi: "Cottage luas dengan kolam renang, pas untuk menghangatkan momen keluarga." },
  { id: "penginapan-saung-gadis", nama: "Saung Gadis", harga: "", hargaAsli: "", hargaDiskon: "Rp 850.000", fasilitas: ["Max 10 Orang", "Kolam Renang", "Dekat Cileunca"], label: "Budget", image: "/saung-gadis.jpg", deskripsi: "Fasilitas lengkap berkapasitas besar, sempurna untuk kumpul santai akhir pekan." },
  { id: "penginapan-saung-rungkun", nama: "Saung Rungkun", harga: "", hargaAsli: "", hargaDiskon: "Rp 1.500.000", fasilitas: ["Max 15 Orang", "Kolam Renang", "Dekat Cileunca"], label: "Budget", image: "/saung-rungkun.jpg", deskripsi: "Pilihan hemat nan nyaman dengan gazebo asri untuk bersantai bersama kerabat." },
  { id: "villa-saung-family-pangalengan", nama: "Saung Family", harga: "", hargaAsli: "", hargaDiskon: "Rp 750.000", fasilitas: ["Max 10 Orang", "Tradisional", "Kolam Renang"], label: "Budget", image: "/saung-family.jpg", deskripsi: "Nuansa tradisional yang menenangkan, lengkap dengan kolam renang menyegarkan." },
  { id: "villa-palayangan", nama: "Villa Palayangan", harga: "", hargaAsli: "", hargaDiskon: "Rp 2.000.000", fasilitas: ["Kapasitas Besar", "View Danau", "Biliard"], label: "Big Size", image: "/villa-palayangan.jpg", deskripsi: "Kemewahan berkapasitas besar dengan panorama eksklusif langsung ke danau." },
  { id: "villa-wantea-pangalengan", nama: "Villa Wantea", harga: "", hargaAsli: "", hargaDiskon: "Rp 3.000.000", fasilitas: ["20-30 Orang", "Gaya Belanda", "Halaman Luas"], label: "Big Size", image: "/villa-wantea.jpg", deskripsi: "Arsitektur klasik bergaya Belanda, sangat sejuk dan muat untuk rombongan besar." },
  { id: "penginapan-barak-ghc-pangalengan", nama: "Barak GHC", harga: "", hargaAsli: "", hargaDiskon: "Rp 2.000.000", fasilitas: ["Max 20 Orang", "View Cileunca", "Cocok utk Kantor"], label: "Big Size", image: "/barak-ghc.jpg", deskripsi: "Solusi cerdas dan nyaman untuk menyukseskan acara keakraban kantor atau kampus." },
  { id: "villa-bts-pangalengan", nama: "Villa BTS", harga: "", hargaAsli: "", hargaDiskon: "Rp 2.000.000", fasilitas: ["Max 20 Orang", "Fasilitas Lengkap", "Nyaman"], label: "Big Size", image: "/villa-bts.jpg", deskripsi: "Kenyamanan maksimal dengan fasilitas komplit untuk menampung seluruh rombongan." },
  { id: "villa-family-c-pangalengan", nama: "Family C", harga: "", hargaAsli: "", hargaDiskon: "Rp 3.000.000", fasilitas: ["Max 30 Orang", "Homestay", "View Cileunca"], label: "Big Size", image: "/family-c.jpg", deskripsi: "Homestay hangat yang siap menyambut dan memanjakan rombongan besar Anda." },
  { id: "villa-family-b-pangalengan", nama: "Family B", harga: "", hargaAsli: "", hargaDiskon: "Rp 2.000.000", fasilitas: ["Max 30 Orang", "View Danau", "Akses Mudah"], label: "Big Size", image: "/family-b.jpg", deskripsi: "Akses super mudah dengan area santai yang menghadap ketenangan air danau." },
  { id: "villa-family-a-pangalengan", nama: "Family A", harga: "", hargaAsli: "", hargaDiskon: "Rp 2.000.000", fasilitas: ["Max 20 Orang", "View Danau", "Nyaman"], label: "Big Size", image: "/family-a.jpg", deskripsi: "Kenyamanan istirahat paripurna dengan view danau yang sungguh memanjakan mata." },
  ...
  { id: "harmony-riverside", nama: "Harmony Riverside", harga: "", hargaAsli: "", hargaDiskon: "Rp 1.750.000", fasilitas: ["Cabin Premium", "View Sungai", "Hutan Rahong"], label: "VIP", image: "/rahong-1.jpg", deskripsi: "Kabin estetik di tengah hutan pinus dengan nyanyian aliran sungai yang damai." },
  { id: "villa-imah-pangalengan", nama: "Vila Imah", harga: "", hargaAsli: "", hargaDiskon: "Rp 5.500.000", fasilitas: ["Max 30 Orang", "VIP Premium", "Eksklusif"], label: "VIP", image: "/villa-imah.jpg", deskripsi: "Standar kemewahan premium untuk menciptakan pengalaman 2 Hari tak terlupakan." },
  { id: "villa-putih-pangalengan", nama: "Vila Putih", harga: "", hargaAsli: "", hargaDiskon: "Rp 6.000.000", fasilitas: ["Max 45 Orang", "Gazebo", "Estetik"], label: "VIP", image: "/villa-putih.jpg", deskripsi: "Vila megah nan estetik dengan kapasitas masif, pilihan utama untuk acara prestisius." },
  { id: "villa-putih-a-pangalengan", nama: "Vila Putih A", harga: "", hargaAsli: "", hargaDiskon: "Rp 3.500.000", fasilitas: ["Max 25 Orang", "Ikonik", "Premium"], label: "VIP", image: "/villa-putih-a.jpg", deskripsi: "Perpaduan harmoni antara desain ikonik dan keindahan alam yang memukau." },
  { id: "villa-bumi-tilu-pangalengan", nama: "Bumi Tilu", harga: "", hargaAsli: "", hargaDiskon: "Rp 4.500.000", fasilitas: ["Max 10 Orang", "Kolam Renang", "Premium Estetik"], label: "VIP", image: "/bumi-tilu.jpg", deskripsi: "Estetika modern di tengah tenangnya alam, lengkap dengan kolam renang eksklusif." },
  { id: "glamping-sagaya-pangalengan", nama: "Glamping Sagaya", harga: "", hargaAsli: "", hargaDiskon: "Rp 750.000", fasilitas: ["Max 4 Orang", "View Kebun Teh", "Estetik"], label: "VIP", image: "/glamping-sagaya.jpg", deskripsi: "Tenda estetik nan nyaman dengan hamparan permadani kebun teh tepat di depan pintu." },
];
            ...
            <div className="mx-auto max-w-6xl px-4 pb-20 pt-8 sm:px-6 lg:px-8">
              <div className="flex items-end justify-between gap-4 mb-12">
                <div className="space-y-1.5 text-center sm:text-left w-full sm:w-auto">
                  ...
                  <p className="max-w-2xl text-sm text-stone-500 font-medium">Pengalaman jujur dari teman-teman yang telah berlibur bersama kami.</p>
                </div>
              ...
              <div id="rel-testi" className="flex gap-4 sm:gap-6 overflow-x-auto pb-8 snap-x snap-mandatory scroll-smooth px-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                {[
                  ...
                  { id: "4", role: "Teman dari Luar Kota", quote: "Gampang banget request ini itu. Kita minta tambahan BBQ dadakan malem-malam langsung disiapin dong sama tim layanannya. Pelayanan bintang 5!", name: "Dina Mariana" }
                ].map((t) => (
              ...
              <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
                ...
                <div className="w-full md:w-[40%] space-y-6 text-center md:text-left">
                  ...
                  <p className="text-stone-600 text-sm sm:text-base leading-relaxed">
                    Tim kami siap merancang itinerary, mengurus logistik, dan memastikan keamanan perjalanan. Hubungi kami untuk penawaran terbaik.
                  </p>
                  <div className="pt-4">
