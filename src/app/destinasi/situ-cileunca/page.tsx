...
export default function SituCileuncaPage() {
  ...
  const jsonLd = {
    ...
    "name": "Situ Cileunca Pangalengan",
    "description": "Danau legendaris seluas 1.400 hektar di Pangalengan. Menawarkan keindahan pemandangan air, tour perahu santai, camping tepi danau, hingga pusat aktivitas rafting.",
    "image": "https://www.gopangalengan.id/cileunca.jpg", // Sesuaikan jika nama foto hero Anda berbeda
    "address": {
      "@type": "PostalAddress",
