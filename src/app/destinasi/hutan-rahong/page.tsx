...
export default function HutanPinusRahongPage() {
  ...
  const jsonLd = {
    ...
    "description": "Pelarian sempurna di bawah kanopi pinus raksasa. Menawarkan pengalaman camping, hammock, dan paintball dengan latar belakang alam Pangalengan yang tenang.",
    "image": "https://www.gopangalengan.id/rahong-1.jpg", 
    "address": {
      "@type": "PostalAddress",
