...
export default function SunriseCukulPage() {
  ...
  const jsonLd = {
    ...
    "name": "Sunrise Point Cukul Pangalengan",
    "description": "Titik terbaik menikmati matahari terbit dan lautan awan di Pangalengan. Menyajikan pemandangan spektakuler kebun teh dan ikonik Villa Merah gaya Eropa.",
    "image": "https://www.gopangalengan.id/cukul.jpg", 
    "address": {
      "@type": "PostalAddress",
