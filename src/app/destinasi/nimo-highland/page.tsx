...
export default function NimoHighlandPage() {
  ...
  // ─── KTP DIGITAL (SCHEMA) DESTINASI WISATA ───
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "TouristAttraction",
    "name": "Nimo Highland Pangalengan",
    "description": "Menyatu dengan hamparan kebun teh, awan, dan arsitektur ikonik bergaya Santorini di puncak Pangalengan. Ikon wisata terbaru Jawa Barat.",
    "image": "https://www.gopangalengan.id/nimo-hero.jpg", 
    "address": {
      "@type": "PostalAddress",
  ...
  return (
    <>
      {/* SUNTIKAN KTP KE HALAMAN (Tidak terlihat oleh user, tapi dipuja oleh Google) */}
      <script
