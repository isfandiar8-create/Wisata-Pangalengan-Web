...
export default function WayangWinduPage() {
  ...
  const jsonLd = {
    ...
    "name": "Wayang Windu Panenjoan Pangalengan",
    "description": "Berjalan di atas awan. Menikmati harmoni hamparan kebun teh hijau yang berpadu dengan kabut magis dan siluet senja di atap Pangalengan.",
    "image": "https://www.gopangalengan.id/wayang.jpg", 
    "address": {
      "@type": "PostalAddress",
